...
| **6** | Chain of 2 followers + velocity alignment reward | Target $dx, dy$ + goal info + velocity differences | Weighted: $0.7 \cdot \text{distance} + 0.3 \cdot \text{cos\_sim(d\_vel)}$ | 10k episodes | 301.1 | ![](docs/gifs/experiment_6.gif) |
