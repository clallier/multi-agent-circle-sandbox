        ...
        for i in range(len(self.agents) - 1, -1, -1):
            if plot_reward_3d is not False:
                ...
                if i == plot_reward_3d:
                    ...
                    positions_X, positions_Y = np.meshgrid(
                    ...
                    for pos_1 in range(len(positions_X)):
                        ...
                        for pos_2 in range(len(positions_Y[pos_1])):
                            self.agents[i].state.p_pos = [
                                positions_X[pos_1, pos_2],
                                positions_Y[pos_1, pos_2],
                            ]
                    ...
                    if azimuth is not None:
                        for angle in range(90):
                            ...
                            ax.view_init(elev=30.0, azim=angle * 4)
...
class BatchMultiAgentEnv(gym.Env):
    metadata = {"runtime.vectorized": True, "render.modes": ["human", "_array"]}
