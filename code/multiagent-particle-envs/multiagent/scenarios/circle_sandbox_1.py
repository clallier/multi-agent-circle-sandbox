...
class Scenario(CircleSandboxBaseScenario):
    """Scenario representing experiment 1 with logarithmic leader distance reward and simple observation."""
    ...
    def observation(self, agent, world):
        """Builds observation containing relative delta x/y to the leader."""
